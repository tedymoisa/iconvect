...
const IubendaConsentSolution = () => {
  useEffect(() => {
    ...
    (window._iub as any).csConfiguration = csConfiguration;

    const loadScript = (id: string, src: string, async: boolean = false, charset: string | null = null) => {
